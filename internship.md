...
-   Create a GitHub account and let me know your user name<sup><a id="fnr.1" class="footref" href="#fn.1" role="doc-backlink">1</a></sup>
...
-   Merge your updates (= blog posts) into the repo<sup><a id="fnr.2" class="footref" href="#fn.2" role="doc-backlink">2</a></sup>
...
-   We meet in the classroom for check in and presentations<sup><a id="fnr.3" class="footref" href="#fn.3" role="doc-backlink">3</a></sup>.
...
used a plethora of platforms, including 3D worlds (Second life<sup><a id="fnr.4" class="footref" href="#fn.4" role="doc-backlink">4</a></sup>),
...
-   Schedule your presentation at least 2 weeks in advance<sup><a id="fnr.8" class="footref" href="#fn.8" role="doc-backlink">8</a></sup>.
...
post elsewhere, in an editor, and then paste it here<sup><a id="fnr.11" class="footref" href="#fn.11" role="doc-backlink">11</a></sup>. Why?
...
-   You can think it over before  posting<sup><a id="fnr.12" class="footref" href="#fn.12" role="doc-backlink">12</a></sup>.
...
-   It's a reminder that you must have the copyrights for the
    image<sup><a id="fnr.13" class="footref" href="#fn.13" role="doc-backlink">13</a></sup>. It is not Okay to just take any old picture without
...
<sup><a id="fn.1" href="#fnr.1">1</a></sup> Feel free to use any user name. You should not have to use your
real name online unless you explicitly want to do it.

<sup><a id="fn.2" href="#fnr.2">2</a></sup> You can do this simply by uploading your file into the
...
<sup><a id="fn.3" href="#fnr.3">3</a></sup> Frequency and dates to be determined. Sessions will last ca. one
hour.

<sup><a id="fn.4" href="#fnr.4">4</a></sup> This particular platform was fun. Read more about it in this
...
<sup><a id="fn.5" href="#fnr.5">5</a></sup> If you miss a blog post (no word limit), you must submit a
substitute essay of no less than 1000 words in the following week.

<sup><a id="fn.6" href="#fnr.6">6</a></sup> That's not a lot of words. Here is an example of 150 words exactly:
...
<sup><a id="fn.7" href="#fnr.7">7</a></sup> The GitHub repo is private and only accessible to other interns,
...
<sup><a id="fn.8" href="#fnr.8">8</a></sup> When you've scheduled a presentation, I will create a folder in
`pdf/` with your name where you can upload your material.

<sup><a id="fn.9" href="#fnr.9">9</a></sup> Here you should be specific and yet professional. Specific,
...
<sup><a id="fn.10" href="#fnr.10">10</a></sup> These could be closed questions (suited for a poll), or open
questions, better suited for discussion.

<sup><a id="fn.11" href="#fnr.11">11</a></sup> You'll sometimes, when I present, see my own editor, which is
...
<sup><a id="fn.12" href="#fnr.12">12</a></sup> I am terrible at that myself - I always post before thinking
things through and end up reposting and editing too many times. One
time is too many! Don't make that mistake, too!

<sup><a id="fn.13" href="#fnr.13">13</a></sup> This sounds easier than it is: obtaining proper copyright
...
<sup><a id="fn.14" href="#fnr.14">14</a></sup> This is an example for a "creative commons" licence. Follow the
