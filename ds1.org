...
- While R will still be our main programming language, I want to
  contrast data science using SQL and Python (perhaps in connection
  with R, though interface packages), and maybe even C/C++.
- The weekly quizzes will be graded.
