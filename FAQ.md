...
1.  [What is this?](#orgd5b837d)
2.  [How should you read?](#org6582982)
3.  [How can you read more research papers?](#org0e22a75)
4.  [Why are we using GitHub?](#orgfa43ebc)
5.  [What is version control?](#org5d7e4b6)
6.  [How should you use GitHub?](#org707488c)
7.  [What is a sprint review?](#org16f3115)
8.  [What do I need to deliver at a sprint review?](#orgf17abe3)
9.  [What should we do in the first sprint?](#org37f85ee)
10. [What should we do in the second sprint?](#orga86baaa)
11. [How do you report on and plan a research "method"?](#org932ab5f)
12. [What should we do in the third sprint?](#org22ec8f9)
13. [What should we do in the fourth sprint?](#orgeecd5f3)
14. [Where I can find out more about "IMRaD"?](#org3a5d77a)
15. [Which editor and IDE do you use?](#org73f0f49)
16. [How can I install Emacs as a data science IDE on Windows 10?](#orgcf8db7c)
17. [How to use GitHub Desktop to backup your code to GitHub](#org5be6581)
18. [How can you always create a great presentation?](#org3138d0e)
19. [How should we prepare for the final presentation?](#org58fbf0a)
20. [What do we have to deliver for the final essay or presentation?](#orgbf2554f)
21. [How is the final essay graded?](#orgef920b6)
22. [What's the difference between an essay and an EDA report?](#org0848196)
23. [How can I install Linux under Windows 10?](#orga7e2ab4)
24. [How can I get Linux tools under Windows 10?](#org29557a8)
25. [How to install R under Windows and MacOS](#org9a6bb92)
26. [How to install a C compiler under Windows and MacOS](#org02dae53)
27. [How to install SQLite under Windws and MacOS](#orgb101485)
28. [How to install Emacs (+ESS) under Windows and MacOS](#orgc031ec2)
29. [How to customize GNU Emacs](#orgb43e5cb)
30. [Completing the GitHub "hello world" exercise](#org56a1934)
31. [References](#orga1ec5bb)
...
scientific writing ([Birkenkrahe, 2014](#org33edb80)).
...
Barbara Minto's Pyramid Principle ([Minto, 2002](#org43270e3)) has a claim to being
the method to achieve this. Here is an illustration followed by an
example below.

![img](./img/minto.png)

(Image source: [powerusersoftwares.com, 2016](#orgeb8282d))
...
presentations. According to Barbara Minto ([Minto, 2002](#org43270e3)), the SCQA
...
For a lecture in 2 parts by me ([2016](#org3fdaf56)), see here:
...
2021). I found out about this from [Gookin (2021)](#orgee44086).

Update November 25, 2021: here is another complete [installation
tutorial](https://ubuntu.com/tutorials/ubuntu-on-windows#1-overview) from the makers of the app ([Morrison, 2021](#org4890568)).
...
figure [280](#org49b1e31) below. To show/hide images, use `C-c C-x C-v`
...
<a id="org33edb80"></a> Birkenkrahe M (2014). Using Storytelling Methods To
...
<a id="org3fdaf56"></a> Birkenkrahe M (Feb 7, 2016). Minto Pyramid Principle Part
...
<a id="orgcfe13b8"></a> Stella J (Nov 11, 2015). A CEO's Guide to Emacs
...
<a id="org4890568"></a> Morrison G (2021). Ubuntu on Windows 10 [website]. [URL:
...
Guide To Emacs](https://www.fugue.co/blog/2015-11-11-guide-to-emacs.html)" ([Stella, 2015](#orgcfe13b8)), which you might enjoy reading. The
