...
1.  [What is this?](#org9b5c9fa)
2.  [How should you read?](#org5e566cf)
3.  [How can you read more research papers?](#org242489d)
4.  [Why are we using GitHub?](#orga454b1d)
5.  [What is version control?](#orge81149b)
6.  [How should you use GitHub?](#org578e9ce)
7.  [What is a sprint review?](#org97de6a2)
8.  [What do I need to deliver at a sprint review?](#orgd16a26d)
9.  [What should we do in the first sprint?](#org13af713)
10. [What should we do in the second sprint?](#orgd6f4388)
11. [How do you report on and plan a research "method"?](#org691fc14)
12. [What should we do in the third sprint?](#org48d6844)
13. [What should we do in the fourth sprint?](#orgb519faa)
14. [Where I can find out more about "IMRaD"?](#org9c12be2)
15. [Which editor and IDE do you use?](#orgef86a54)
16. [How can I install Emacs as a data science IDE on Windows 10?](#org56fe029)
17. [How to use GitHub Desktop to backup your code to GitHub](#org464993e)
18. [How can you always create a great presentation?](#orga6d64c2)
19. [How should we prepare for the final presentation?](#org38031da)
20. [What do we have to deliver for the final essay or presentation?](#org9a07eae)
21. [How is the final essay graded?](#org737afca)
22. [What's the difference between an essay and an EDA report?](#org4e17e54)
23. [How can I install Linux under Windows 10?](#org8944a57)
24. [How can I get Linux tools under Windows 10?](#org2fd737e)
25. [How to install R under Windows and MacOS](#org632fbb4)
26. [How to install a C compiler under Windows and MacOS](#org54933a0)
27. [How to install SQLite under Windws and MacOS](#orgaf554ec)
28. [How to install Emacs (+ESS) under Windows and MacOS](#orga7afd5c)
29. [How to customize GNU Emacs](#org0922b9e)
30. [Completing the GitHub "hello world" exercise](#orge0a1773)
31. [References](#orga5983a7)
...
scientific writing ([Birkenkrahe, 2014](#org490963c)).
...
Barbara Minto's Pyramid Principle ([Minto, 2002](#orgc72c2e5)) has a claim to being
the method to achieve this. Here is an illustration followed by an
example below.

![img](./img/minto.png)

(Image source: [powerusersoftwares.com, 2016](#org48cf0c2))
...
presentations. According to Barbara Minto ([Minto, 2002](#orgc72c2e5)), the SCQA
...
For a lecture in 2 parts by me ([2016](#org586734d)), see here:
...
2021). I found out about this from [Gookin (2021)](#org212a771).

Update November 25, 2021: here is another complete [installation
tutorial](https://ubuntu.com/tutorials/ubuntu-on-windows#1-overview) from the makers of the app ([Morrison, 2021](#org620004b)).
...
figure [280](#orgd87477d) below. To show/hide images, use `C-c C-x C-v`
...
<a id="org490963c"></a> Birkenkrahe M (2014). Using Storytelling Methods To
...
<a id="org586734d"></a> Birkenkrahe M (Feb 7, 2016). Minto Pyramid Principle Part
...
<a id="orgc10f939"></a> Stella J (Nov 11, 2015). A CEO's Guide to Emacs
...
<a id="org620004b"></a> Morrison G (2021). Ubuntu on Windows 10 [website]. [URL:
...
Guide To Emacs](https://www.fugue.co/blog/2015-11-11-guide-to-emacs.html)" ([Stella, 2015](#orgc10f939)), which you might enjoy reading. The
