...
1.  [What is this?](#orgb41718e)
2.  [How should you read?](#org2e86222)
3.  [How can you read more research papers?](#orgb5f3da8)
4.  [Why are we using GitHub?](#org8c9d01d)
5.  [What is version control?](#org9aa3b15)
6.  [How should you use GitHub?](#orgd4effed)
7.  [What is a sprint review?](#orgcb2ef90)
8.  [What do I need to deliver at a sprint review?](#org64a047f)
9.  [What should we do in the first sprint?](#org61e7754)
10. [What should we do in the second sprint?](#org0fe403e)
11. [How do you report on and plan a research "method"?](#orgc937388)
12. [What should we do in the third sprint?](#orga7313dd)
13. [What should we do in the fourth sprint?](#orgeae5edf)
14. [Where I can find out more about "IMRaD"?](#org3399b60)
15. [Which editor and IDE do you use?](#org5f2e737)
16. [How can I install Emacs as a data science IDE on Windows 10?](#org96f6452)
17. [How to use GitHub Desktop to backup your code to GitHub](#org06a48e9)
18. [How can you always create a great presentation?](#org3bb65f6)
19. [How should we prepare for the final presentation?](#org4f2e49e)
20. [What do we have to deliver for the final essay or presentation?](#org61a975e)
21. [How is the final essay graded?](#org665550b)
22. [What's the difference between an essay and an EDA report?](#orgaa259b1)
23. [How can I install Linux under Windows 10?](#org225885d)
24. [How can I get Linux tools under Windows 10?](#org4397b4e)
25. [How to install R under Windows and MacOS](#org0156ae3)
26. [How to install a C compiler under Windows and MacOS](#orgdd7ca68)
27. [How to install SQLite under Windws and MacOS](#org9b75882)
28. [How to install Emacs (+ESS) under Windows and MacOS](#orge373276)
29. [How to customize GNU Emacs](#org5a95a46)
30. [Completing the GitHub "hello world" exercise](#org74b1523)
31. [References](#org8f710c9)
...
scientific writing ([Birkenkrahe, 2014](#orge31a23b)).
...
Barbara Minto's Pyramid Principle ([Minto, 2002](#org860750b)) has a claim to being
the method to achieve this. Here is an illustration followed by an
example below.

![img](./img/minto.png)

(Image source: [powerusersoftwares.com, 2016](#org655fbd7))
...
presentations. According to Barbara Minto ([Minto, 2002](#org860750b)), the SCQA
...
For a lecture in 2 parts by me ([2016](#orgbd1f82d)), see here:
...
2021). I found out about this from [Gookin (2021)](#org65b969a).

Update November 25, 2021: here is another complete [installation
tutorial](https://ubuntu.com/tutorials/ubuntu-on-windows#1-overview) from the makers of the app ([Morrison, 2021](#orgf2fef4c)).
...
figure [280](#org96bf570) below. To show/hide images, use `C-c C-x C-v`
...
1.  Your **contributions** are shown on your **profile** page.
...
<a id="orge31a23b"></a> Birkenkrahe M (2014). Using Storytelling Methods To
...
<a id="orgbd1f82d"></a> Birkenkrahe M (Feb 7, 2016). Minto Pyramid Principle Part
...
<a id="org1960058"></a> Stella J (Nov 11, 2015). A CEO's Guide to Emacs
...
<a id="orgf2fef4c"></a> Morrison G (2021). Ubuntu on Windows 10 [website]. [URL:
...
Guide To Emacs](https://www.fugue.co/blog/2015-11-11-guide-to-emacs.html)" ([Stella, 2015](#org1960058)), which you might enjoy reading. The
