...
1.  [What is this?](#orgb372bfb)
2.  [How should you read?](#org2161bca)
3.  [How can you read more research papers?](#org2b317c0)
4.  [Why are we using GitHub?](#org55745df)
5.  [What is version control?](#orga244fd4)
6.  [How should you use GitHub?](#org71f17c2)
7.  [What is a sprint review?](#org5b86296)
8.  [What do I need to deliver at a sprint review?](#org28d9267)
9.  [What should we do in the first sprint?](#org67a8f70)
10. [What should we do in the second sprint?](#orgfd254fd)
11. [How do you report on and plan a research "method"?](#orgf22be43)
12. [What should we do in the third sprint?](#org03f4508)
13. [What should we do in the fourth sprint?](#org5c9bc15)
14. [Where I can find out more about "IMRaD"?](#org5c74d7f)
15. [Which editor and IDE do you use?](#org19fb526)
16. [How can I install Emacs as a data science IDE on Windows 10?](#orgf95f2f0)
17. [How to use GitHub Desktop to backup your code to GitHub](#org5111817)
18. [How can you always create a great presentation?](#orgd6220f5)
19. [How should we prepare for the final presentation?](#org29a10cb)
20. [What do we have to deliver for the final essay or presentation?](#org8144571)
21. [How is the final essay graded?](#org9873155)
22. [What's the difference between an essay and an EDA report?](#orgbe15736)
23. [References](#org465ceae)
...
scientific writing ([Birkenkrahe, 2014](#org9988de7)).
...
The figure [94](#orge3c520d) shows four (out of an arbitrary number of)
...
Barbara Minto's Pyramid Principle ([Minto, 2002](#org3c58f9b)) has a claim to being
the method to achieve this. Here is an illustration followed by an
example below.

![img](./img/minto.png)

(Image source: [powerusersoftwares.com, 2016](#orgffa792e))
...
presentations. According to Barbara Minto ([Minto, 2002](#org3c58f9b)), the SCQA
...
For a lecture in 2 parts by me ([2016](#org68b4d50)), see here:
...
<a id="org9988de7"></a> [Birkenkrahe M (2014). Using Storytelling Methods To
...
<a id="org68b4d50"></a> Birkenkrahe M (Feb 7, 2016). Minto Pyramid Principle Part
...
<a id="orgc96cf11"></a> Berlin Professional School (BPS). Presentation Assessment
Form.

<a id="org3c58f9b"></a> Minto B (2002). The Pyramid Principle.

Harrison Metal (2014). Storytelling & Presenting 1: Thank You,
Barbara Minto [video]. [Online: vimeo.com](https://vimeo.com/87537935)

<a id="orgffa792e"></a> Power-user (Jul 31, 2016). Give a brilliant structure to
...
<a id="org111a9b7"></a> Stella J (Nov 11, 2015). A CEO's Guide to Emacs
...
Guide To Emacs](https://www.fugue.co/blog/2015-11-11-guide-to-emacs.html)" ([Stella, 2015](#org111a9b7)), which you might enjoy reading. The
