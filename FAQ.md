...
1.  [What is this?](#org26b7e76)
2.  [How should you read?](#org2d980c2)
3.  [How can you read more research papers?](#org4cfa83a)
4.  [Why are we using GitHub?](#org8b1fa3f)
5.  [What is version control?](#orga02db23)
6.  [How should you use GitHub?](#org4fb609c)
7.  [What is a sprint review?](#org32e4876)
8.  [What do I need to deliver at a sprint review?](#org71bb339)
9.  [What should we do in the first sprint?](#orgb993fa5)
10. [What should we do in the second sprint?](#orgdddf273)
11. [How do you report on and plan a research "method"?](#org07122c5)
12. [What should we do in the third sprint?](#org8d59e70)
13. [What should we do in the fourth sprint?](#org12e849f)
14. [Where I can find out more about "IMRaD"?](#orgeabc157)
15. [Which editor and IDE do you use?](#org41a3b4a)
16. [How can I install Emacs as a data science IDE on Windows 10?](#orgeb8ceb2)
17. [How to use GitHub Desktop to backup your code to GitHub](#org5291aa9)
18. [How can you always create a great presentation?](#orgec783ea)
19. [How should we prepare for the final presentation?](#org53134f2)
20. [What do we have to deliver for the final essay or presentation?](#orgf409311)
21. [How is the final essay graded?](#org52a9145)
22. [What's the difference between an essay and an EDA report?](#org8b758f6)
23. [How can I install Linux under Windows 10?](#org125d7f0)
24. [How can I get Linux tools under Windows 10?](#org0df0819)
25. [How to install R under Windows and MacOS](#org0856ae9)
26. [How to install a C compiler under Windows and MacOS](#orgac7cfd9)
27. [How to install SQLite under Windws and MacOS](#org4ffe02e)
28. [How to install Emacs (+ESS) under Windows and MacOS](#org341417b)
29. [How to customize GNU Emacs](#org97f40e4)
30. [Completing the GitHub "hello world" exercise](#org2321257)
31. [References](#orge6af914)
...
scientific writing ([Birkenkrahe, 2014](#orge2b4fbf)).
...
Barbara Minto's Pyramid Principle ([Minto, 2002](#org8a9ab4c)) has a claim to being
the method to achieve this. Here is an illustration followed by an
example below.

![img](./img/minto.png)

(Image source: [powerusersoftwares.com, 2016](#orga67430e))
...
presentations. According to Barbara Minto ([Minto, 2002](#org8a9ab4c)), the SCQA
...
For a lecture in 2 parts by me ([2016](#orga5c679f)), see here:
...
2021). I found out about this from [Gookin (2021)](#org8d8ba9a).

Update November 25, 2021: here is another complete [installation
tutorial](https://ubuntu.com/tutorials/ubuntu-on-windows#1-overview) from the makers of the app ([Morrison, 2021](#org63532d5)).
...
-   [The Absolute Beginner's Guide to Emacs](https://youtu.be/48JlgiBpw_I) (System Crafters, 2021) -
    1hr11min ([so good that I made notes](https://github.com/birkenkrahe/org/blob/master/emacs_beginner.org#absolute-beginners-guide-to-emacs)).
...
figure [280](#orgcf74cdc) below. To show/hide images, use `C-c C-x C-v`
...
<a id="orge2b4fbf"></a> Birkenkrahe M (2014). Using Storytelling Methods To
...
<a id="orga5c679f"></a> Birkenkrahe M (Feb 7, 2016). Minto Pyramid Principle Part
...
<a id="orgdd8472f"></a> Stella J (Nov 11, 2015). A CEO's Guide to Emacs
...
<a id="org63532d5"></a> Morrison G (2021). Ubuntu on Windows 10 [website]. [URL:
...
Guide To Emacs](https://www.fugue.co/blog/2015-11-11-guide-to-emacs.html)" ([Stella, 2015](#orgdd8472f)), which you might enjoy reading. The
