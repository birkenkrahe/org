...
** Timing
   ...
   +The final presentation is a presentation of 30-45 minutes (for a team of 2-3), or 20 minutes (for an individual presenter), including discussion. The exact timing depends on the course setting (numberof total presentations and available time). Ask me in class!+
...
* Why Emacs?
  ...
  * [[https://betterprogramming.pub/15-reasons-why-i-use-emacs-with-gifs-5b03c6608b61][15 Reasons Why I Use Emacs With GIFs]] (Tarnowski, 2020).
