...
* What should we do for the final presentation?
   ...
   | No. | Content     | Did you research the topic (literature review)?                               |
   |   1 |             | Did you make an effort to quantify statements (graphs, tables)?               |
   |   2 |             | Were your graphs and tables clear and unambiguous?[fn:26]                     |
   |   3 |             | Did you explain where your content came from?                                 |
   |   4 |             | Did you demonstrate an effort to validate your sources?                       |
   |   5 |             | Were you able to answer questions about the slides?                           |
   |   6 |             | Are you aware of the limitations of your research (method and personal bias)? |
   |   7 |             | Did you select those results suitable for presentation?                       |
   |   8 | Form        | Did you make an effort to optimize your slides?[fn:25]                        |
   |   9 |             | How was your diction, spelling, mistakes on slides?                           |
   |  10 |             | Did the presentation seem rehearsed and well-tested?                          |
   |  11 |             | Were you dressed appropriate to the occasion?[fn:22]                          |
   |     |             | Did the presentation have a clear, logical structure?[fn:27]                  |
   |  12 | Interaction | Did you make an effort to involve the audience?                               |
   |  13 | References  | Did you provide references, with consistent and complete citations            |
   |  14 |             | Did you use inline references on slides?                                      |
   |  15 | Team        | How well did you work together during the presentation[fn:24]                 |
   |  16 | Timing      | Did you respect the timelines (start/end)?[fn:23]                             |
