...
* Completing the GitHub "hello world" exercise
  ...
  3) Opening a *pull* request. You do this once you are sure that your
  ...
  4) You can now *merge* the pull request with the *main* branch. The
  ...
  /Figure: Pull request successfully merged and closed/
    ...
    5) Your *contributions* are shown on your *profile* page. 
