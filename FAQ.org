...
(In the past, I have also used ~org-tree-slide-mode~ to present, but I
prefer ~org-present~ now for lectures. For the slickest results, try
~reveal.js~, for the quickest presentation, use ~M-x epresenter-run~)
